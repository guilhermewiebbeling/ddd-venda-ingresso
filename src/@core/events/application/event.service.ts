...
export class EventService {
    ...
    async create(input: {name: string, description?: string, date: Date, partner_id: string}) {
        const partner = await this.parnterRepo.findById(input.partner_id);
    ...
    async update(id: string, input : {name?: string, description?: string, date?: Date}) {
        ...
        input.description && event.changeDescription(input.name)
